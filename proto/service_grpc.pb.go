...
const (
	ChatService_MessageChannel_FullMethodName   = "/proto.ChatService/MessageChannel"
...
type ChatServiceClient interface {
	MessageChannel(ctx context.Context, in *MessageChannelRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MessageChannelResponse], error)
...
func (c *chatServiceClient) MessageChannel(ctx context.Context, in *MessageChannelRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MessageChannelResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], ChatService_MessageChannel_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MessageChannelRequest, MessageChannelResponse]{ClientStream: stream}
...
type ChatService_MessageChannelClient = grpc.ServerStreamingClient[MessageChannelResponse]
...
type ChatServiceServer interface {
	MessageChannel(*MessageChannelRequest, grpc.ServerStreamingServer[MessageChannelResponse]) error
...
func (UnimplementedChatServiceServer) MessageChannel(*MessageChannelRequest, grpc.ServerStreamingServer[MessageChannelResponse]) error {
...
func _ChatService_MessageChannel_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).MessageChannel(m, &grpc.GenericServerStream[MessageChannelRequest, MessageChannelResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChatService_MessageChannelServer = grpc.ServerStreamingServer[MessageChannelResponse]
